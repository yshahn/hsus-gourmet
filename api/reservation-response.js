...
module.exports = async function handler(req, res) {
  ...
  // "click" action links automatically before the guest ever taps them, which
  // used to fire duplicate admin notifications on every hit. We now check the
  // current status first and only notify once per unique response.
